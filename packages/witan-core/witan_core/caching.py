...
:func:`hint_kwargs` exists so both servers share one TTL and one documented
scope rationale rather than drifting apart.
...
def hint_kwargs(
    ...
    """Cache arguments for ``FastMCP(**hint_kwargs())``.
