...
[`deployed-witan-onboarding.md`](deployed-witan.md), which has the
...
[ADR-0007](../explanation/decisions/0007-local-to-shared-store-migration-transport.md) for the full
...
(see [`deployed-witan-onboarding.md`](deployed-witan.md)), so
