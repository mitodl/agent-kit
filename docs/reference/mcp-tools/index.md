...
witan exposes **62 MCP tools** across four domains. A single `witan serve` mounts all of them, so one MCP entry in your agent's config gets you the whole surface.
