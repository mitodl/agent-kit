"""Shared fixtures for omnigraph-memory tests.
...
def server(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("OMNIGRAPH_MEMORY_REPO", "https://github.com/test/repo")
    monkeypatch.setenv("OMNIGRAPH_MEMORY_AUTHOR", "pytest")

    from omnigraph_memory import config as cfg_mod
    from omnigraph_memory import graph as graph_mod
