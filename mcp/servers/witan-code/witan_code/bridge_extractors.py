...
def _is_csrf_only_client(text: str) -> bool:
    """Return True if the file imports redux-hammock/django_csrf_fetch.

    Indicates the file uses same-origin relative-URL CSRF fetching and its
    endpoint consumers should not be recorded as cross-repo.
    """
