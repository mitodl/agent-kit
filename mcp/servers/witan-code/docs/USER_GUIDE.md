...
index. See the main [README](../README.md) for the full two-layer table.
...
- **Cross-repo interface bindings** — `env_var` / `endpoint` / `package` /
  ...
  Cross-repo context bridge](../README.md#cross-repo-context-bridge-layer-25).
...
`omnigraph` binary in one step. See the [witan README](../../witan/README.md)
...
[README § Supported languages](../README.md#supported-languages) for what's
...
- [SYMBOL_FORMAT.md](SYMBOL_FORMAT.md) — the canonical symbol string format
  bindings are keyed on.
- [STAGE2_STITCHING.md](STAGE2_STITCHING.md) — the precise join algorithm.
- [EDGE_PRECISION_TIERS.md](EDGE_PRECISION_TIERS.md) — the `min_precision`
